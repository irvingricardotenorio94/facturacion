...
// src/db/schema/emisores.ts
var emisor = sqliteTable("emisor", {
  id: integer("id").primaryKey({ autoIncrement: true }),
...
// src/db/schema/receptores.ts
var receptores = sqliteTable("receptores", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  userId: integer("user_id").notNull().references(() => users.id),
  rfc: text("rfc").notNull(),
  razonSocial: text("razon_social").notNull(),
...
// src/db/schema/catalogos.ts
var catUsoCFDI = sqliteTable("cat_uso_cfdi", {
...
auth.post("/login", async (c) => {
  ...
  try {
    ...
    const payload = {
      ...
      // Incluimos username en el payload
      email: user.email,
...
var CryptoService = class {
  ...
  static async getCryptoKey(secretKey) {
    const encoder = new TextEncoder();
  ...
  static async decrypt(encryptedBase64, secretKey) {
...
// src/routes/emisores.ts
var emisores = new Hono2();
...
var emisores_default = emisores;

// src/routes/receptores.ts
var clientes = new Hono2();
...
clientes.get("/", async (c) => {
  ...
  const payload = c.get("jwtPayload");
  try {
    const misReceptores = await db.select().from(receptores).where(eq(receptores.userId, payload.id));
    return c.json({ success: true, data: misReceptores });
  } catch (e) {
    return c.json({ success: false, error: "Error al obtener receptores" }, 500);
  }
});
var receptores_default = clientes;

// src/routes/catalogos.ts
var catalogos = new Hono2();
catalogos.get("/uso-cfdi", async (c) => {
  const db = drizzle(c.env.isabel_db);
  const result = await db.select().from(catUsoCFDI).all();
  return c.json(result);
});
var catalogos_default = catalogos;

// src/data/usoCfdi.json
var usoCfdi_default = [
  {
    id: "G01",
    descripcion: "Adquisici\xF3n de mercanc\xEDas",
    fisica: true,
    moral: true,
    regimenes: ["601", "603", "606", "612", "620", "621", "622", "625", "626"]
  },
  {
    id: "G02",
  ...
  {
    id: "I04",
    descripcion: "Equipo de c\xF3mputo y accesorios",
    fisica: true,
    moral: true,
    regimenes: ["601", "603", "606", "612", "620", "621", "622", "625", "626"]
  },
  ...
  {
    id: "I06",
    descripcion: "Comunicaciones telef\xF3nicas",
    fisica: true,
    moral: true,
    regimenes: ["601", "603", "606", "612", "620", "621", "622", "625", "626"]
  },
  ...
  {
    id: "D01",
    descripcion: "Honorarios m\xE9dicos, dentales y gastos hospitalarios",
    fisica: true,
    moral: false,
    regimenes: ["605", "606", "607", "608", "611", "612", "614", "615", "616", "625"]
  },
  {
    id: "D02",
    descripcion: "Gastos m\xE9dicos por incapacidad o discapacidad",
    fisica: true,
    moral: false,
    regimenes: ["605", "606", "607", "608", "611", "612", "614", "615", "616", "625"]
  },
  ...
  },
  {
    ...
    fisica: true,
    moral: true,
    regimenes: ["601", "603", "605", "606", "607", "608", "610", "611", "612", "614", "615", "616", "620", "621", "622", "623", "624", "625", "626", "628", "629", "630"]
  },
  {
    id: "CP01",
    descripcion: "Pagos",
...
__name(seedCatalogos, "seedCatalogos");
...
var apiRoutes = {
  auth: auth_default,
  emisores: emisores_default,
  receptores: receptores_default,
...
// ../../node_modules/.pnpm/wrangler@4.69.0_@cloudflare+workers-types@4.20260301.1/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// ../../node_modules/.pnpm/wrangler@4.69.0_@cloudflare+workers-types@4.20260301.1/node_modules/wrangler/templates/middleware/common.ts
